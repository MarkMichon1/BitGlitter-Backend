...
from bg_backend.bitglitter.config.palettefunctions import import_custom_palette_from_header
...
from bg_backend.bitglitter.read.decode.headerdecode import custom_palette_header_validate_decode, frame_header_decode, \
...
class VideoFrameProcessor:
    def __init__(self, dict_obj):
        ...
        read_frame_process_http(self.frame_position)
